...
Todo List – это список дел, которые вам нужно выполнить или того, что вы хотите сделать. В приложении можно добавлять/удалать/(отмечать как выжные) дела или задания, которые вводятся через специальную форму.
